        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <li><a href="#" className="hover:text-orange-500 transition">Shipping Info</a></li>
              <li><a href="#" className="hover:text-orange-500 transition">Returns & Exchanges</a></li>
              <li><a href="#" className="hover:text-orange-500 transition">Size Guide</a></li>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-4">
              <a href="#" className="text-gray-400 hover:text-orange-500 transition text-2xl" title="Facebook">📘</a>
              <a href="#" className="text-gray-400 hover:text-orange-500 transition text-2xl" title="Twitter">🐦</a>
              <a href="#" className="text-gray-400 hover:text-orange-500 transition text-2xl" title="Instagram">📷</a>
              <a href="#" className="text-gray-400 hover:text-orange-500 transition text-2xl" title="YouTube">🎥</a>
            </div>
            <p className="text-gray-400 text-sm">
